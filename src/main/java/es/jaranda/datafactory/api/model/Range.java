...
/**
 * Defines a range of items which can be iterated or can be used in a lazy
 * way
 * @author Jorge
...
public class Range<T> implements Iterable<T> {
    ...
    /**
     * Range of items which can be iterated or can be used in a lazy
     * way
     ...
     *                       values.
     *                       <p> For example: new Range(1, 5, i -> i + 2) 
     *                           generates: [1, 3, 5] values
     */
